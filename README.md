...
（2026-09-07）仍为 `NO_TARGETS`：`config/default.yaml` 的10f只是固定观察基线，
...
> 75条结果现仅作历史单切分观察。恢复IC-HAC准入口径并退役
> `intraday_scene_amp_flow_20d`后，2026-09-07正式检验605个因子，119个通过者已写入
> 有效因子库；这不会自动改变10f观察基线或生产批准状态。
