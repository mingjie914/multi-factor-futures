...
F14 = B1
# 10因子: 13剔除3个负贡献增量 (泄漏修复后边际)
F10 = [x for x in F13 if x not in (
    'intraday_turnover_velocity_20d', 'intraday_open_close_volume_ratio_20d',
...
def main():
    ...
    for name, s in [('6因子', s6), ('10因子', s10), ('13因子', s13), ('14因子', s14)]:
        st = seg(s)
